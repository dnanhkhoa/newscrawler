...
def _combine_div_tags(parent_tag, main_tag='div'):
    if parent_tag is None or isinstance(parent_tag, NavigableString) or parent_tag.name != main_tag:
        return None

    parent_tag.wrap(create_html_tag(main_tag, attrs=parent_tag.attrs))
